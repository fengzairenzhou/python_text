...
class Users(models.Model):
	...
	def toDict(self):
		return {'id':self.id,'username':self.username,'name':self.name,'sex':self.sex,'address':self.address,'code':self.code,'phone':self.phone,'email':self.email,'addtime':self.addtime}
